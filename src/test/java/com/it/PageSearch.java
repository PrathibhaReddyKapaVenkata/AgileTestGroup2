...
public void ProceedtoChekout() throws InterruptedException  {
    ...
    //new WebDriverWait(driver, 20).until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div/div[2]/div/div/a"))).click();

    /*WebElement scanEle =new WebDriverWait(driver, 20).until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div/div[2]/div/div/a")));
    Actions action =new Actions(driver);
    action.moveToElement(scanEle).click().build().perform();*/


   // driver.findElement(ByClassName("btn btn-primary")).click();
    Thread.sleep(1000);
